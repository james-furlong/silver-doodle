//
//  PedestrianCounterLocationResponse.swift
//  Light up the night
//
...
struct PedestrianCounterLocationResponseElement: Codable {
...
typealias PedestrianCounterLocationResponse = [PedestrianCounterLocationResponseElement]
